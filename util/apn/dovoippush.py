...
if __name__ == '__main__':
    ...
    token = cfg['devices'][device_name]['voip_token']
    push_cfg = {
        'use_sandbox': True,
        'cert_file': cfg['apple']['voip_cert'],
        'key_file': cfg['apple']['voip_key']
    }
    custom = {
        'key': 'val'
    }
    ...
    o.push_device(
        token, alert=sys.argv[2], badge=0, content_available=1, custom=custom
    )
